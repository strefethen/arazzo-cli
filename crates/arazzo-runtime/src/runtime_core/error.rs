...
impl RuntimeErrorKind {
    pub fn code(self) -> &'static str {
        match self {
            ...
            Self::RedirectDowngradeRefused => "RUNTIME_REDIRECT_DOWNGRADE_REFUSED",
            Self::RedirectLimitExceeded => "RUNTIME_REDIRECT_LIMIT_EXCEEDED",
            ...
            Self::SourceDescriptionLoad => "RUNTIME_SOURCE_DESCRIPTION_LOAD",
